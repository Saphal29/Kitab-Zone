...
<head>
  ...
  <title>Library App - Reports & Insights</title>
    ...
    <main class="main-content">
      ...
      <div class="card">
        ...
        <div class="card-content">
          <h2 class="card-title">Generate Circulation Reports</h2>
          <p class="card-subtitle">Track book borrowing and circulation trends.</p>
        </div>
      ...
      <div class="card">
        ...
        <div class="card-content">
          <h2 class="card-title">Create Inventory Reports</h2>
          <p class="card-subtitle">Monitor library inventory status.</p>
        </div>
        <button class="card-action">Create</button>
      </div>

      <div class="card">
        <i class="fas fa-user"></i>
        <div class="card-content">
          <h2 class="card-title">Export Student Activity</h2>
          <p class="card-subtitle">Analyze student library usage and activity.</p>
        </div>
      ...
      <div class="card">
        ...
        <div class="card-content">
          <h2 class="card-title">Analyze Popular Genres</h2>
          <p class="card-subtitle">Get insights into popular books and genres.</p>
        </div>
        <button class="card-action">Analyze</button>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-content">
          ...
          <p class="card-subtitle">Track fines collection and financial data.</p>
        </div>
        <button class="card-action">Generate</button>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-content">
          <h2 class="card-title">Create Summary Reports</h2>
          <p class="card-subtitle">Generate monthly and annual reports.</p>
        </div>
        <button class="card-action">Create</button>
      </div>
    </main>
